          ...
          <section className="section bg-light mt-5">
            ...
            <section className="bg-light py-5 mt-5">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-6">
                            <h6 className="text-primary text-uppercase">Chúng tôi</h6>
                            <h1 className="mb-4">6 Năm Kinh Nghiệm Cùng Với Dream Laptop</h1>
                        </div>
                    </div>
                    <div className="row g-4 mb-3 pb-3">
                        <div className="col-12 wow fadeIn" data-wow-delay="0.1s">
                            <div className="d-flex">
                                ...
                                <div className="ps-3">
                                    <h6>Chất lượng và Tin cậy</h6>
                                    <p>Với 6 năm kinh nghiệm trong việc cung cấp laptop và dịch vụ hỗ trợ, Dream Laptop cam kết mang đến cho bạn sự chất lượng và tin cậy. Chúng tôi hiểu rõ tầm quan trọng của một chiếc laptop đối với công việc và giải trí của bạn.</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-12 wow fadeIn" data-wow-delay="0.3s">
                            <div className="d-flex">
                                ...
                                <div className="ps-3">
                                    <h6>Sự Đa Dạng và Linh hoạt</h6>
                                    <p>Dream Laptop luôn cung cấp sự đa dạng và linh hoạt để bạn có thể tùy chỉnh và lựa chọn laptop phù hợp nhất với nhu cầu của bạn. Với sự lựa chọn từ các thương hiệu hàng đầu và cấu hình đa dạng, chúng tôi sẽ giúp bạn tìm kiếm chiếc laptop mơ ước.</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-12 wow fadeIn" data-wow-delay="0.5s">
                            <div className="d-flex">
                                ...
                                <div className="ps-3">
                                    ...
                                    <p>Đội ngũ của chúng tôi được đào tạo chuyên nghiệp và luôn sẵn sàng hỗ trợ bạn trong việc chọn lựa, mua sắm và bảo trì laptop. Với Dream Laptop, bạn sẽ luôn cảm thấy yên tâm và hài lòng.</p>
                                </div>
                            </div>
                        </div>
                    </div>
