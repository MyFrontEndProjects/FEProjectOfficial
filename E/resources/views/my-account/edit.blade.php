...
@section('sect5')
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            @endif
            <form action="{{ route('editAccount.update', ['id'=> $data['info']->id]) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row row-cols-1 row-cols-sm-2">
                    ...
                    <div class="col">
                        <div class="mb-3 row">
                            <label class="col-lg-2 col-md-6 col-sm-12 col-form-label">Hình đại diện</label>
                            <div class="col-lg-10 col-md-6 col-sm-12">
